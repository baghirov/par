    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_reputation_group', to='otree.Session')),
            ],
            options={
                'db_table': 'quiz_reputation_group',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('round_number', otree.db.models.PositiveIntegerField(db_index=True, null=True)),
                ('session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quiz_reputation_subsession', to='otree.Session')),
            ],
            options={
                'db_table': 'quiz_reputation_subsession',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='quiz_reputation.Group')),
                ('participant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_reputation_player', to='otree.Participant')),
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quiz_reputation_player', to='otree.Session')),
                ('subsession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz_reputation.Subsession')),
            ],
            options={
                'db_table': 'quiz_reputation_player',
            },
        ...
        migrations.AddField(
            model_name='group',
            name='subsession',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='quiz_reputation.Subsession'),
        ),
    ]
